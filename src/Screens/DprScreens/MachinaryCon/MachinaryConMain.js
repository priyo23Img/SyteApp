...
import AddNewMachinary from '../InnerScreens/AddNewMachinary'
const MachinaryConMain = () => {
    const refRBSheet = useRef();
  return (
    <View style={{ backgroundColor: '#fff', flex: 1 }}>
      <CommonHeards title={"Machinery Consumption"} />
      ...
      <ScrollView>
        <View style={styles.ContentBox}>
          <View style={styles.ContentBack}>
            <Text style={styles.ContentTitle}>JCB</Text>
          </View>
        ...
        <View style={styles.ContentBox}>
          <View style={styles.ContentBack}>
            <Text style={styles.ContentTitle}>Bulldozer</Text>
          </View>
          <TextInput style={[styles.InputStyle,{width:'10%'}]} />
          <TextInput style={styles.InputStyle} />
          <TextInput style={styles.InputStyle} />
        ...
        <View style={styles.ContentBox}>
          <View style={styles.ContentBack}>
            <Text style={styles.ContentTitle}>Crane</Text>
          </View>
          <TextInput style={[styles.InputStyle,{width:'10%'}]} />
          <TextInput style={styles.InputStyle} />
          <TextInput style={styles.InputStyle} />
        ...
        <View style={styles.ContentBox}>
          <View style={styles.ContentBack}>
            <Text style={styles.ContentTitle}>Bore</Text>
          </View>
          <TextInput style={[styles.InputStyle,{width:'10%'}]} />
          <TextInput style={styles.InputStyle} />
          <TextInput style={styles.InputStyle} />
...
export default MachinaryConMain
