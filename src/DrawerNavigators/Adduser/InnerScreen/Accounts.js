...
const Accounts = () => {
  ...
  const HandleValidate = () => {
    if (!input.PhnNo || !input.Accountname || !input.email || !input.busName || !input.busAddress) {
  ...
  return (
    <>
      <CommonHeards title={"Account Team"} />
      <ScrollView style={{
        backgroundColor: '#fff',
        flex: 1
      }}>
        <View style={styles.LoginContainer}>
          <CommonTextInputs
            ...
            Inputname={input.Accountname}
            Inputfieldname={'Accountname'}
